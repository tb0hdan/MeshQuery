...
def convert_bytes_to_base64(obj: Any) -> Any:
    """
    Recursively convert bytes and memoryview objects to base64 strings for JSON serialization.

    Args:
        obj: The object to process, which may contain bytes or memoryview objects

    Returns:
        The object with all bytes and memoryview objects converted to base64 strings
    """
...
def sanitize_floats(obj: Any) -> Any:
    ...
    # Handle memoryview and bytes objects
    if isinstance(obj, (bytes, memoryview)):
        return convert_bytes_to_base64(obj)
    ...
    # Anything else leave untouched – other helpers may convert it later
    return obj
